            ...
            <div class="col-md-6">
                <div class="product-detail">
                    ...
                    {{-- <form action="{{ url('/user/keranjang') }}" method="POST" class="d-flex flex-column gap-3">
                        ...
                        <button type="submit"
                            class="btn btn-primary btn-sm rounded-2 w-100 d-flex align-items-center justify-content-center gap-2">
                        ...
                        <button type="button"
                            class="btn btn-warning btn-sm rounded-2 w-100 d-flex align-items-center justify-content-center gap-3"
                            onclick="window.location.href='{{ route('user.produk.index') }}'">
