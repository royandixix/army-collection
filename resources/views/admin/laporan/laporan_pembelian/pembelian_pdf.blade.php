...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-size: 10pt; /* Ukuran font lebih sesuai untuk laporan */
            color: #333; /* Warna teks lebih lembut */
            margin: 20px; /* Margin di sekitar dokumen */
            padding: 0;
            line-height: 1.5;
        }
        ...
        header {
            text-align: center;
            margin-bottom: 30px;
            border-bottom: 3px solid #0056b3; /* Garis pemisah biru */
            padding-bottom: 10px;
        }
        header h1 {
            margin: 0;
        ...
        th, td {
            border: 1px solid #ddd; /* Garis tabel lebih tipis dan terang */
            padding: 8px 12px; /* Padding lebih luas */
            text-align: left;
        }
        th {
            background-color: #f0f8ff; /* Warna header lebih lembut (Light Sky Blue) */
            color: #000;
            font-weight: 700;
            font-size: 11pt;
        ...
        tfoot td {
            font-weight: bold;
            border-top: 3px solid #0056b3; /* Garis tebal biru */
            background-color: #e6f7ff; /* Latar belakang total */
            font-size: 12pt;
            color: #0056b3;
        }
...
<body>
    ...
    @forelse($pembelians as $index => $pembelian)
        @php
            // Akses sebagai object, bukan array
